...
În acest capitol prezint funcționarea \TeX{} și \LaTeX{} și problemele pe care
le au. Apoi prezint cum au rezolvat alții aceste deficiențe folosind technologii
web.
...
excutat codul dacă compilarea documentului se va termina.
...
de dimenisuni mai mari cum ar fi resursele), o optimizare posibilă ar fi să se
folosească hard link-uri către fișierele din \eng{file store}.
